    ...
    <div>
        ...
        <button @click="loadCreateModal" class="btn btn-primary btn-block">Add New task</button>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-bind:key="(task, index) in tasks" >
                        <td>{{index + l}}</td>
                        <td>{{task.name}}</td>
                        <td>{{task.body}}</td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger" v-if="errors.length > 0">
                            <ul>
                                <li v-bind:key="error in error">{{error}}</li>
                            </ul>
                        </div>
                        
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input v-model="task.name" id="name" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="description">Description</label>
                            <input v-model="task.body" id="name" class="form-control">
                        </div>
            ...
            <div class="modal fade" id="update-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input v-model="new_update_task.name" id="name" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="description">Description</label>
                            <input v-model="new_update_task.body" id="name" class="form-control">
                        </div>
    ...
    export default {
        ...
        data(){
            return {
                ...
                tasks: [],
                uri: 'https://single-page.test/tasks',
                errors: [],
                new_update_task: [],
        ...
        methods: {
            ...
            deleteTask(index){
                ...
                let confirmBox = confirm("Do you really ant to delete this?");
            ...
            loadTasks(){
                ...
                axios.get(this.uri).then(respon=>{
